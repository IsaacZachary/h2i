...
<div class="container">
	...
	<div class="content-area">
		<main id="content" class="site-main" role="main">
			<?php $lz_computer_repair_layout_option = get_theme_mod( 'lz_computer_repair_theme_options', 'Right Sidebar' );
		    if($lz_computer_repair_layout_option == 'Left Sidebar'){ ?>
		    	<div class="row">
			...
			<?php }else if($lz_computer_repair_layout_option == 'Right Sidebar'){ ?>
				<div class="row">
					<div id="" class="content_area col-lg-8 col-md-8">
						<section id="post_section">
							<?php
			...
			<?php }else if($lz_computer_repair_layout_option == 'One Column'){ ?>
			...
			<?php }else if($lz_computer_repair_layout_option == 'Three Columns'){ ?>	
				<div class="row">
			...
			<?php }else if($lz_computer_repair_layout_option == 'Four Columns'){ ?>
				<div class="row">
					<div id="sidebar" class="col-lg-3 col-md-3"><?php dynamic_sidebar('sidebar-1'); ?></div>
	    	...
	    	<?php }else if($lz_computer_repair_layout_option == 'Grid Layout'){ ?>
		    	<div class="row">
			    	<div id="" class="content_area col-lg-8 col-md-8">
						<section id="post_section">
							<div class="row">
